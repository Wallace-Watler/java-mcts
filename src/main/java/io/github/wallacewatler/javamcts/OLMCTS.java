...
/**
 * <b>Open-loop Monte Carlo tree search (OLMCTS)</b><br>
...
public interface OLMCTS {
     ...
     *
     * @implSpec The tree is discarded once search is complete. Trees are not reused between searches because
     * information is gained after applying an action to the true game state; previous searches operated without that
    ...
    /**
     * Actions are chosen by players and applied to states to progress the game. An {@code OLMCTS.Action} may involve
     * randomness.
     *
     * @version 0.1.0
     * @since 0.1.0
